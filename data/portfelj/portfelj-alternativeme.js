        ...
        for(var j=0; j<data.length; j++) {
            for(var v=0; v<myValute.length; v++) {
                if ( ( !((myValute[v].valuta == 'BAT')||(myValute[v].valuta == 'CAN')||(myValute[v].valuta == 'ACC')) && (myValute[v].valuta == data[j].symbol)) ||
                    ...
                    myValute[v].tecaj        = parseFloat(data[j].price_usd) * 0.88; // 14.07.2026: prej price_eur - alternative.me API vraca napacen EUR tecaj (59k namesto 55k za BTC), zato rocna konverzija USD*0.88 (1$=0.88EUR)
...
*/
        ...
        //console.log(data);
        if(false) { for(var j=0; j<data.data.length; j++) {
